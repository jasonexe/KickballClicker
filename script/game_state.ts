...
let updateState = function (existingState: GameState, action: Action): GameState {
...
let checkForOuts = function (state: GameState) {
...
let resetCount = function (state: GameState) {
    state.strike = 0;
    state.ball = 0;
    state.foul = 0;
}
 ...
 */
let fillState = function (stateToFill: GameState, existingState: GameState) {
